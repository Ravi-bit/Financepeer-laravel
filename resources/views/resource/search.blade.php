...
@endsection
@section('searches')
<h4 style="text-align: center; font-family:'Aclonica', sans-serif;font-weight: bold; margin-top:28px;margin-bottom:10px;">Searches for "{{$searching}}"</h4>

<div class="container">

@forelse($sproducts as $p)
   <div class="boxing">
  ...
  <div class="modal-dialog  modal-dialog-centered" style="padding: 10px;">
   ...
   @empty
    <div style="text-align: center;" class="jumbotron">
       <h4 style="font-style: italic; color:gray">No products available for {{$searching}}</h4>
    </div>
  @endforelse
</div>
